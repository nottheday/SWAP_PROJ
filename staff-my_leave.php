...
/* Cancel (optional) — only your own pending leave */
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'cancel') {
    ...
    elseif ($staff_id <= 0) $error = "Staff record not found.";
        ...
        // Only cancel if it belongs to this staff and is pending
        ...
        if (!$ok) {
            ...
            // Try update to 'cancelled' if allowed; if fails, fallback to delete
  ...
  <aside class="sidebar">
    ...
    <nav>
      <ul class="nav-menu">
        ...
        <li class="nav-item"><a href="staff-my_leave.php" class="nav-link active"><span class="nav-icon">📅</span><span>My Leave</span></a></li>
    ...
    <section class="panel">
      ...
      <div class="panel-body">
        ...
        <?php else: ?>
            ...
            <tbody>
              <?php foreach ($my_leave as $lv): ?>
                <tr>
                  ...
                  <td><span class="status-badge <?php echo htmlspecialchars(strtolower($lv['status'])); ?>"><?php echo htmlspecialchars(strtoupper($lv['status'])); ?></span></td>
                  <td>
          ...
          <p class="muted" style="margin-top:10px;">Security: cancel is restricted to your own pending requests (no IDOR).</p>
        <?php endif; ?>
      </div>
    </section>
  </main>
